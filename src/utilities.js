...
function sortingDishesCB(dishA, dishB){
...
function sortDishes(dishes){
    return [...dishes].sort(sortingDishesCB);
}
...
function menuPrice(dishesArray){
    ...
    function addTwoParametersCB(a, b){
        return a + b;
    }
    ...
    const dishArr = dishesArray.map(getDishPriceCB);
    return dishArr.reduce(addTwoParametersCB,0);
